...
public class Init_planet37 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_init_planet37);

        context = this;

        toolBar = findViewById(R.id.toolbar);
        setSupportActionBar(toolBar);
        getSupportActionBar().setTitle("플래닛37");
        ...
        counterFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Init_planet37.this, ShoppingCart.class);
        ...
        databaseReference = database.getReference("Planet37");
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Log.e("Init_planet37", String.valueOf(error.toException()));
            }
        });
